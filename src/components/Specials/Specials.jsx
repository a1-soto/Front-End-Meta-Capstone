  ...
  const specials = [
    {
      ...
      title: "Greek Salad",
      price: "$12.99",
      description: "Fresh vegetables, olives and feta cheese served with our signature dressing."
    },
    {
      id: 2,
      image: bruschetta,
      title: "Bruschetta",
      price: "$8.99",
      description: "Grilled bread with tomatoes, basil and extra virgin olive oil."
    },
    {
      id: 3,
      image: seaBass,
    ...
    },
    {
      ...
      price: "$7.99",
      description: "Homemade lemon tart topped with toasted Italian meringue."
    },
    {
      id: 5,
      image: baklava,
      title: "Baklava",
      price: "$6.99",
      description: "Layers of filo pastry with pistachios and honey syrup."
    }
  ];
